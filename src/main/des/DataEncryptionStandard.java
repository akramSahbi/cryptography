...
public class DataEncryptionStandard {
    public static void main(String[] args) {
        ...
        System.out.println("Enter text to encrypt using data encyption standard cipher:");
        String plaintext = scanner.nextLine();
        System.out.print("Random Key generated value: ");
        SecretKey key = generateRandomKey();
        System.out.println(key);
        String ciphertext = encrypt(plaintext, key);
        System.out.println("Encrypted using data encyption standard algorithm: " + ciphertext);
        String decryptedText = decrypt(ciphertext, key);
        System.out.println("decrypted back using data encyption standard cipher: " + decryptedText);
    }
